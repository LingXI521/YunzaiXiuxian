...
import { Read_player, isNotNull, get_random_talent } from "../Xiuxian/xiuxian.js"
import { Add_najie_thing, Add_修为, Add_血气, Add_HP, exist_najie_thing } from "../Xiuxian/xiuxian.js"
        ...
        for (let player_id of playerList) {
            ...
            if (action != null) {
                ...
                if (action.Place_actionplus == "0") {
                    ...
                    if (weizhi.name == "三清山" || weizhi.name == "张家界" || weizhi.name == "九寨沟" || weizhi.name == "啵唧的小金库" || weizhi.name == "低级") {
                    ...
                    if (weizhi.name == "青城山" || weizhi.name == "武当山" || weizhi.name == "龙虎山" || weizhi.name == "中级" || weizhi.name == "职场") {
                        monster_length = data.monster_list2.length;
                        monster_index = Math.trunc(Math.random() * monster_length);
                        monster = data.monster_list2[monster_index];
                    }
                    if (weizhi.name == "试炼" || weizhi.name == "华山" || weizhi.name == "衡山" || weizhi.name == "嵩山" || weizhi.name == "高级" || weizhi.name == "轮回池") {
                        monster_length = data.monster_list3.length;
                        monster_index = Math.trunc(Math.random() * monster_length);
                        monster = data.monster_list3[monster_index];
                    }
                    if (weizhi.name == "神兽试炼" || weizhi.name == "灭仙洞" || weizhi.name == "禁忌海" || weizhi.name == "雷风岛" || weizhi.name == "仙遗之地" || weizhi.name == "无欲天仙" || weizhi.name == "须弥") {
                        monster_length = data.monster_list4.length;
                        monster_index = Math.trunc(Math.random() * monster_length);
                        monster = data.monster_list4[monster_index];
                    }
                    if (weizhi.name == "剑冢" || weizhi.name == "影界" || weizhi.name == "剑帝传承") {
                        monster_length = data.monster_list4.length;
                        monster_index = Math.trunc(Math.random() * monster_length);
                        monster = data.monster_list5[monster_index];
                    }
                    if (weizhi.name == "蓬莱岛" || weizhi.name == "昆仑山" || weizhi.name == "方诸山" || weizhi.name == "杀神崖" || weizhi.name == "斩魔谷" || weizhi.name == "仙界矿场" || weizhi.name == "诸神黄昏·旧神界") {
                    ...
                    if (random1 <= x) {
                        if (random2 <= y) {//random2=0到1随机数,y=0.6
                            if (random3 <= z) {
                        ...
                        if (weizhi.one[0].name != "洗根水") {//判断是不是旧神界
                    ...
                    if (msgg.find(item => item == A_win)) {
                        ...
                        last_msg += m + "不巧撞见[" + B_player.名号 + "],经过一番战斗,击败对手,获得修为" + xiuwei + ",气血" + qixue + ",剩余血量" + A_player.当前血量 + ",剩余次数" + (action.cishu - 1);
                        let random = Math.random()//万分之一出神迹
                        if (random < 0.0001) {
                            last_msg += "\n" + B_player.名号 + "倒下后,一道刺眼的圣光落下,你缓缓睁开了眼,发现了[无主的神之心]正散发着幽芒的白光";
                        ...
                        if (random > 0.9 && random < 0.901 && (weizhi.name == "高级" || weizhi.name == "中级" || weizhi.name == "低级")) {
                            let wangzi = "银丝仙网";
                            if (weizhi.name == "中级") {
                                if (Math.random() < 0.1) {
                                    wangzi = "金丝仙网";
                            ...
                            last_msg += "\n" + B_player.名号 + "倒下后,他的身体开始坍塌，你向前伸出手来，却只抓住了一张[" + wangzi + "]";
